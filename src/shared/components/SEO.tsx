import { useLocation } from "@tanstack/react-router"; // ← use TanStack's hook
import { Helmet } from "react-helmet-async";
import { useTranslation } from "react-i18next";

import { brandConfig } from "@/shared/config/brand";
import { getLocaleDirection, siteConfig } from "@/shared/config/site";
...
export function SEO({
  ...
  const location = useLocation(); // TanStack location
